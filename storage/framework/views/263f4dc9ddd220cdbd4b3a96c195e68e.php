        ...
        <div class="col-lg-8 text-center">
            <div class="card shadow-lg border-0">
                <div class="card-body p-5">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <a href="<?php echo e(route('todos.index')); ?>" class="btn btn-primary btn-lg w-100 h-100 py-4">
                        ...
                        <div class="col-md-6">
                            <a href="<?php echo e(route('todos.create')); ?>" class="btn btn-primary btn-lg w-100 h-100 py-4">
...
document.addEventListener('DOMContentLoaded', function() {
    function refreshStats() {
        ...
        fetch("<?php echo e(route('todos.stats')); ?>") 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SS TECHNOLOGY BD\Desktop\TaskNext\resources\views/dashboard.blade.php ENDPATH**/ ?>